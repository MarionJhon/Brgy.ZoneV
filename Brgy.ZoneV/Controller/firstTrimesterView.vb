...
Public Class firstTrimesterView
    ...
    Private Sub LoadData()
        Dim query As String = "SELECT patient_id, date_of_visit, gestational_age, blood_pressure, weight, uri_result, hemog_level,
         ROW_NUMBER() OVER (PARTITION BY patient_id ORDER BY first_trim_saverecord_id) AS first_id
        FROM first_trim_saverecord WHERE patient_id = @patientId
        ORDER BY first_trim_saverecord_id ASC"
        ...
        Using conn As New MySqlConnection(connString)
            Try
                ...
                Using cmd As New MySqlCommand(query, conn)
                    ...
                    firstDataGridView.DataSource = dataTable.DefaultView
                End Using
    ...
    Private Sub Guna2DateTimePicker1_ValueChanged(sender As Object, e As EventArgs) Handles Guna2DateTimePicker1.ValueChanged, firstDt.ValueChanged
        Dim selectedDate As DateTime = firstDt.Value
