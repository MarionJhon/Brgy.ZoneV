...
Partial Class addStaff
    ...
    Private Sub InitializeComponent()
        ...
        mname = New Guna.UI2.WinForms.Guna2TextBox()
        ...
        gender.CustomizableEdges = CustomizableEdges1
        ...
        gender.ItemHeight = 30
        gender.Items.AddRange(New Object() {"Male", "Female"})
        gender.Location = New Point(32, 358)
        gender.Name = "gender"
        gender.ShadowDecoration.CustomizableEdges = CustomizableEdges2
        ...
        Guna2HtmlLabel9.Location = New Point(32, 333)
        Guna2HtmlLabel9.Name = "Guna2HtmlLabel9"
        Guna2HtmlLabel9.Size = New Size(55, 19)
        Guna2HtmlLabel9.TabIndex = 118
        Guna2HtmlLabel9.Text = "Gender:"' 
        ' dob
        ' 
        dob.BackColor = Color.Transparent
        dob.BorderRadius = 5
        dob.Checked = True
        dob.CustomizableEdges = CustomizableEdges3
        ...
        dob.Location = New Point(32, 291)
        dob.MaxDate = New DateTime(9998, 12, 31, 0, 0, 0, 0)
        dob.MinDate = New DateTime(1753, 1, 1, 0, 0, 0, 0)
        dob.Name = "dob"
        dob.ShadowDecoration.CustomizableEdges = CustomizableEdges4
        dob.Size = New Size(208, 36)
        dob.TabIndex = 117
        dob.Value = New DateTime(2023, 11, 16, 18, 29, 51, 101)
        ' 
        ' Guna2HtmlLabel8
        ' 
        ...
        Guna2HtmlLabel8.Location = New Point(272, 133)
        Guna2HtmlLabel8.Name = "Guna2HtmlLabel8"
        Guna2HtmlLabel8.Size = New Size(35, 19)
        Guna2HtmlLabel8.TabIndex = 116
        Guna2HtmlLabel8.Text = "Role:"' 
        ' lname
        ' 
        lname.BorderRadius = 5
        lname.CustomizableEdges = CustomizableEdges5
        lname.DefaultText = ""
        ...
        lname.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        lname.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        lname.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        lname.Font = New Font("Yu Gothic UI", 9F, FontStyle.Regular, GraphicsUnit.Point)
        lname.ForeColor = Color.Black
        lname.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        lname.Location = New Point(32, 224)
        lname.Name = "lname"
        lname.PasswordChar = ChrW(0)
        lname.PlaceholderText = ""
        lname.SelectedText = ""
        lname.ShadowDecoration.CustomizableEdges = CustomizableEdges6
        lname.Size = New Size(208, 36)
        lname.TabIndex = 115
        ' 
        ' Guna2HtmlLabel7
        ' 
        ...
        Guna2HtmlLabel7.Location = New Point(32, 199)
        Guna2HtmlLabel7.Name = "Guna2HtmlLabel7"
        Guna2HtmlLabel7.Size = New Size(76, 19)
        Guna2HtmlLabel7.TabIndex = 114
        Guna2HtmlLabel7.Text = "Last Name:"' 
        ' mname
        ' 
        mname.BorderRadius = 5
        mname.CustomizableEdges = CustomizableEdges7
        mname.DefaultText = ""
        mname.DisabledState.BorderColor = Color.FromArgb(CByte(208), CByte(208), CByte(208))
        mname.DisabledState.FillColor = Color.FromArgb(CByte(226), CByte(226), CByte(226))
        mname.DisabledState.ForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        mname.DisabledState.PlaceholderForeColor = Color.FromArgb(CByte(138), CByte(138), CByte(138))
        mname.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        mname.Font = New Font("Yu Gothic UI", 9F, FontStyle.Regular, GraphicsUnit.Point)
        mname.ForeColor = Color.Black
        mname.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        mname.Location = New Point(32, 157)
        mname.Name = "mname"
        mname.PasswordChar = ChrW(0)
        mname.PlaceholderText = ""
        mname.SelectedText = ""
        mname.ShadowDecoration.CustomizableEdges = CustomizableEdges8
        mname.Size = New Size(208, 36)
        mname.TabIndex = 113
        ' 
        ' Guna2HtmlLabel6
        ' 
        ...
        Guna2HtmlLabel6.Location = New Point(32, 132)
        Guna2HtmlLabel6.Name = "Guna2HtmlLabel6"
        Guna2HtmlLabel6.Size = New Size(94, 19)
        Guna2HtmlLabel6.TabIndex = 112
        Guna2HtmlLabel6.Text = "Middle Name:"' 
        ' fname
        ' 
        fname.BorderRadius = 5
        fname.CustomizableEdges = CustomizableEdges9
        fname.DefaultText = ""
        ...
        fname.Font = New Font("Yu Gothic UI", 9F, FontStyle.Regular, GraphicsUnit.Point)
        fname.ForeColor = Color.Black
        fname.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        fname.Location = New Point(32, 91)
        fname.Name = "fname"
        fname.PasswordChar = ChrW(0)
        fname.PlaceholderText = ""
        fname.SelectedText = ""
        fname.ShadowDecoration.CustomizableEdges = CustomizableEdges10
        fname.Size = New Size(208, 36)
        fname.TabIndex = 111
        ' 
        ' btnSave
        ' 
        ...
        btnSave.Location = New Point(320, 426)
        ...
        Guna2HtmlLabel5.Location = New Point(32, 266)
        Guna2HtmlLabel5.Name = "Guna2HtmlLabel5"
        Guna2HtmlLabel5.Size = New Size(87, 19)
        Guna2HtmlLabel5.TabIndex = 109
        Guna2HtmlLabel5.Text = "Date of Birth:"' 
        ' Guna2HtmlLabel4
        ' 
        ...
        Guna2HtmlLabel4.Location = New Point(272, 266)
        Guna2HtmlLabel4.Name = "Guna2HtmlLabel4"
        Guna2HtmlLabel4.Size = New Size(68, 19)
        Guna2HtmlLabel4.TabIndex = 108
        ...
        Guna2HtmlLabel3.Location = New Point(272, 199)
        ...
        Guna2HtmlLabel1.TabIndex = 105
        Guna2HtmlLabel1.Text = "Add Staff"' 
        ' Guna2HtmlLabel10
        ' 
        ...
        Guna2HtmlLabel10.Location = New Point(272, 66)
        Guna2HtmlLabel10.Name = "Guna2HtmlLabel10"
        Guna2HtmlLabel10.Size = New Size(33, 19)
        Guna2HtmlLabel10.TabIndex = 124
        Guna2HtmlLabel10.Text = "Age:"' 
        ' age
        ' 
        age.BorderRadius = 5
        age.CustomizableEdges = CustomizableEdges13
        age.DefaultText = ""
        ...
        age.Location = New Point(272, 91)
        age.Name = "age"
        age.PasswordChar = ChrW(0)
        age.PlaceholderText = ""
        age.SelectedText = ""
        age.ShadowDecoration.CustomizableEdges = CustomizableEdges14
        ...
        role.BorderRadius = 5
        role.CustomizableEdges = CustomizableEdges15
        role.DrawMode = DrawMode.OwnerDrawFixed
        role.DropDownStyle = ComboBoxStyle.DropDownList
        role.FocusedColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        role.FocusedState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        role.Font = New Font("Yu Gothic UI", 9F, FontStyle.Regular, GraphicsUnit.Point)
        role.ForeColor = Color.Black
        role.ItemHeight = 30
        role.Location = New Point(272, 157)
        role.Name = "role"
        role.ShadowDecoration.CustomizableEdges = CustomizableEdges16
        role.Size = New Size(208, 36)
        role.TabIndex = 126
        ' 
        ' username
        ' 
        username.BorderRadius = 5
        username.CustomizableEdges = CustomizableEdges17
        ...
        username.Font = New Font("Yu Gothic UI", 9F, FontStyle.Regular, GraphicsUnit.Point)
        username.ForeColor = Color.Black
        username.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        username.Location = New Point(272, 224)
        username.Name = "username"
        username.PasswordChar = ChrW(0)
        username.PlaceholderText = ""
        username.SelectedText = ""
        username.ShadowDecoration.CustomizableEdges = CustomizableEdges18
        username.Size = New Size(208, 36)
        username.TabIndex = 127
        ' 
        ' password
        ' 
        password.BorderRadius = 5
        password.CustomizableEdges = CustomizableEdges19
        ...
        password.Font = New Font("Yu Gothic UI", 9F, FontStyle.Regular, GraphicsUnit.Point)
        password.ForeColor = Color.Black
        password.HoverState.BorderColor = Color.FromArgb(CByte(94), CByte(148), CByte(255))
        password.Location = New Point(272, 291)
        password.Name = "password"
        password.PasswordChar = "*"c
        password.PlaceholderText = ""
        password.SelectedText = ""
        password.ShadowDecoration.CustomizableEdges = CustomizableEdges20
        password.Size = New Size(208, 36)
        password.TabIndex = 128
        ' 
        ' Guna2ControlBox1
        ' 
        Guna2ControlBox1.Anchor = AnchorStyles.Top Or AnchorStyles.Right
        Guna2ControlBox1.BackColor = Color.FromArgb(CByte(144), CByte(183), CByte(125))
